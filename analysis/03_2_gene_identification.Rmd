...
master_snps <- merge(all_snps, all_genes[, c("rs", "gene_name")], by = "rs", all.x = TRUE)
write.csv(master_snps, "~/Desktop/GCRF/GCRF-Final/analysis/analysis_output/results_master.csv")
```
